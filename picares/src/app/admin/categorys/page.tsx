...
const CategorysAdminPage = () => {
  ...
  const doDelete = async (id: number) => {
    try {
      await request(`/api/categorys/${id}`, { method: "DELETE" });
      ...
      <PageContainer>
        <ProTable<RESPONSE.Categorys>
          ...
          request={async (params, sort, filter) => {
            ...
            const { code, data } = (await request("/api/categorys/query", {
              method: "POST",
              headers: {
...
export default CategorysAdminPage;
